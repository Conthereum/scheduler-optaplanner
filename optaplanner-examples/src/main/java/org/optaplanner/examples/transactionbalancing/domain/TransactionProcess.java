...
import org.optaplanner.examples.transactionbalancing.domain.solver.TransactionComputerStrengthComparator;
import org.optaplanner.examples.transactionbalancing.domain.solver.TransactionProcessDifficultyComparator;
import org.optaplanner.examples.common.domain.AbstractPersistable;
import org.optaplanner.examples.common.swingui.components.Labeled;

import com.fasterxml.jackson.annotation.JsonIgnore;

@PlanningEntity(difficultyComparatorClass = TransactionProcessDifficultyComparator.class)
public class TransactionProcess
    ...
    public TransactionProcess(long id, int requiredCpuPower, int requiredMemory, int requiredNetworkBandwidth) {
        super(id);
    ...
    @PlanningVariable(strengthComparatorClass = TransactionComputerStrengthComparator.class)
