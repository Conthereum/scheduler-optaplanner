...
public class EmvBalancingGenerator extends LoggingMain {
    ...
    public static void main(String[] args) {
        EmvBalancingGenerator generator = new EmvBalancingGenerator();
    ...
    public EmvBalancingGenerator(boolean withoutDao) {
        if (!withoutDao) {
