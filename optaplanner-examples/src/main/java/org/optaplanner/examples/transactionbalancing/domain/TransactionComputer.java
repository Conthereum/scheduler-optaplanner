...
@JsonIdentityInfo(scope = TransactionComputer.class, generator = ObjectIdGenerators.PropertyGenerator.class, property = "id")
public class TransactionComputer
    ...
    public TransactionComputer(long id, int cpuPower, int memory, int networkBandwidth, int cost) {
        super(id);
