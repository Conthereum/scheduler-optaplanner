...
public class TransactionBalanceSolutionFileIO extends JacksonSolutionFileIO<TransactionBalance> {

    public TransactionBalanceSolutionFileIO() {
        super(TransactionBalance.class);
    }
}
