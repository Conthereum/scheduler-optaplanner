...
class TransactionBalancingSmokeTest extends SolverSmokeTest<TransactionBalance, HardSoftScore> {

    private static final String UNSOLVED_DATA_FILE = "data/transactionbalancing/unsolved/200computers-600processes" +
            ".json";

    @Override
    protected TransactionBalancingApp createCommonApp() {
